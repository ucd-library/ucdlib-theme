...
class UcdlibListAccordion extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  ...
  constructor() {
    super();
    this.render = _ucdlib_list_accordion_tpl_js__WEBPACK_IMPORTED_MODULE_1__.render.bind(this);
    this.listItems = [];
  ...
  static get styles() {
    return (0,_ucdlib_list_accordion_tpl_js__WEBPACK_IMPORTED_MODULE_1__.styles)();
  }
...
function styles() {
  ...
  `;
  return [
    (0,lit__WEBPACK_IMPORTED_MODULE_0__.unsafeCSS)(_ucd_lib_theme_sass_2_base_class_lists_css_js__WEBPACK_IMPORTED_MODULE_2__.default.cssText.replaceAll(":root", ":host")), 
